...
class _LTPanelFormState extends State<LTPanelForm> {
  ...
  final TextEditingController _incomingCurrentController = TextEditingController();
  final TextEditingController _outgoingCurrentController = TextEditingController();
  @override
  void initState() {
                ...
                child: Column(
                  children: [
                    Padding(
                      ...
                      child: Text("LT Panel Data",style: TextStyle(fontSize: 20),),
                    ),
                    Padding(
