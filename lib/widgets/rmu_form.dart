...
class _RMUFormState extends State<RMUForm> {
  final TextEditingController _circuitBreakerController = TextEditingController();
  final TextEditingController _wayController = TextEditingController();
  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    _circuitBreakerController.text = this.widget.rmuModel.cktBkrRating.toString();
                ...
                child: Column(
                  children: [
                    Padding(
                      ...
                      child: Text("RMU Data",style: TextStyle(fontSize: 20),),
                    ),
                    Padding(
